...
% CDOUBLET() is a pre-provided function to compute the u and v velocity components produced at a point p with coordinates p = [xp,zp] by a constant strength doublet panel with end points 
